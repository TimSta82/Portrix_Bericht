...
%													{thesis}								%											% Bezeichnung arbeit oder thesis 
%													{Thorben Kay}							%							% Author
%													{Entwicklung eines Multi-Effekt Gerätes für E-Gitarren auf Basis eines Ein-Platinen-Computers}											  % Titel				
...
%													{Diese Arbeit dokumentiert die Entwicklung eines Multi-Effekt Gerätes für E-Gitarren. Nach der Beschreibung der für die Realisierung erforderlichen Grundlagen werden die Anforderungen an das Gerät festgesetzt. Basierend darauf wird die Planungs- und Realisierungsphase beschrieben. Abschließend werden die Ergebnisse entsprechender System- und Komponententests ausgewertet.
%}																					% Kurzzusammenfassung
...
%---------------------------------------------------------------------------------------------------
	\input{chapter/Endpart/Summary.tex}
...
%---------------------------------------------------------------------------------------------------		
  ...
  \input{literatur/literatur}			 %KAY: WAR DRINNEN   																		% hier können alle Schriftstücke aufgeführt werden, die nicht zitiert, aber dennoch nennenswert sind!
